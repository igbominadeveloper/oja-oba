    ...
    <div class="columns is-account-grid is-multiline">
        <div class="column is-4">
            ...
            <div class="flat-card upload-card is-auto">
                <div class="card-body">
                    <!-- Avatar form -->
                    <div id="avatar-upload" class="avatar-wrapper has-simple-popover" data-content="Change profile picture" data-placement="top" data-target="webuiPopover3">
                        <img class="profile-pic" src="https://image.ibb.co/b04PYv/placeholder_w.jpg" alt="">
                        <div class="upload-button">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus upload-icon" aria-hidden="true"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        </div>
        ...
        <div class="column is-8">
            ...
            <div class="flat-card profile-info-card is-auto">
                ...
                <div class="card-title">
                    ...
                    <div class="confirm-button">
                        <a href="javascript:void(0);" role="button" class="has-simple-popover" data-content="Save Contact info" data-placement="top" data-target="webuiPopover4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check feather-icons"><polyline points="20 6 9 17 4 12"></polyline></svg></a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="columns">
            ...
            <div class="flat-card profile-info-card is-auto has-overflow">
                ...
                <div class="card-title">
                    ...
                    <div class="confirm-button">
                        <a href="javascript:void(0);" role="button" class="has-simple-popover" data-content="Save Addresses" data-placement="top"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check feather-icons"><polyline points="20 6 9 17 4 12"></polyline></svg></a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="columns">
                        ...
                        <div class="column is-6">
                            ...
                            <div class="info-block">
                                ...
                                <div class="chosen-container chosen-container-single" title="" style="width: 100%;"><a class="chosen-single">
