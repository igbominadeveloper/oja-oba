	                   ...
	                   <div class="columns account-header">
	                       <div class="column is-10 is-offset-1 checkout-wrapper is-tablet-landscape-padded">
	                               ...
	                               <div class="columns is-gapless is-vcentered">
	                                           ...
	                                           <div class="columns is-multiline is-gapless">
	                                                           ...
	                                                           <g>
	                                                               <g>
	                                                                   <path d="M508.401,180.988L260.934,1.788c-2.327-2.327-6.206-2.327-9.309,0L3.383,181.764c-3.103,2.327-3.879,5.43-3.103,8.533
	                                                                            ...
	                                                                            V349.328h100.849V496.722z M481.25,239.946c-44.218,0-396.412,0-449.939,0v-44.218H481.25V239.946z"/>
	                                                               </g>
	                                                           </g>
	                                                           <g>
	                                                               <g>
	                                                                   <path d="M256.28,59.194c-30.255,0-55.079,24.824-55.079,55.079c0,30.255,24.824,55.079,55.079,55.079
	                                                                            ...
	                                                                            C295.068,135.219,278.001,153.061,256.28,153.061z"/>
	                                                               </g>
	                                                           </g>
	                                                           <g>
	                                                               <g>
	                                                                   <path d="M318.34,281.837H74.753c-3.879,0-7.758,3.103-7.758,7.758v175.321c0,3.879,3.103,7.758,7.758,7.758H318.34
	                                                                            ...
	                                                                            l-80.679-72.921l80.679-68.267V447.073z"/>
	                                                               </g>
	                                                           </g>
	                                                           <g>
	                                                               <g>
	                                                                   <path d="M385.831,380.358c-4.655,0-7.758,3.103-7.758,7.758v28.703c0,4.655,3.103,7.758,7.758,7.758s7.758-3.103,7.758-7.758
	                                                                            v-28.703C393.589,384.237,389.71,380.358,385.831,380.358z"/>
	                                                               </g>
	                                                           </g>
	       
	                                                       </svg>
	                                                       <!-- Method name -->
	                                                       <div class="shipping-method">Postal box</div>
	                                                       <!-- Method price -->
	                                               ...
	                                               <div class="column is-6">
	                                                   ...
	                                                   <div class="mini-card">
	                                                       ...
	                                                       <!-- Method name -->
	                                                       <div class="shipping-method">Delivery</div>
	                                                       <!-- Method price -->
	                                                       <div class="shipping-price">$12</div>
	                                                       <!-- Indicator -->
	                                                       <div class="active-indicator">
	                                                           <i data-feather="check"></i>
	                                                       </div>
	                                               ...
	                                               <div class="column is-6">
	                                                   ...
	                                                   <div class="mini-card">
	                                                       ...
	                                                       <!-- Method name -->
	                                                       <div class="shipping-method">Drone Express</div>
	                                                       <!-- Method price -->
	                                                       <div class="shipping-price">$24</div>
	                                                       <!-- Indicator -->
	                                                       <div class="active-indicator">
	                                                           <i data-feather="check"></i>
	                                                       </div>
	                                               ...
	                                               <div class="column is-6">
	                                                   ...
	                                                   <div class="mini-card">
	                                                       ...
	                                                       <!-- Method name -->
	                                                       <div class="shipping-method">Super Express</div>
	                                                       <!-- Method price -->
	                                                       <div class="shipping-price">$36</div>
	                                                       <!-- Indicator -->
	                                                       <div class="active-indicator">
	                                                           <i data-feather="check"></i>
	                                                       </div>
	                                   ...
	                                   <div class="webui-popover-content">
	                                       <div class="popover-flex-block">
	                                           ...
	                                           <div class="content-block">Before jumping to the next step, you need to specify a shipping method</div>
	                                       </div>
	                                   </div>
	                                           ...
	                                           <div class="columns is-multiline">
	                                               ...
	                                               <div class="column is-6">
	                                                   <div class="control">
	                                                       ...
	                                                       <input type="text" class="input" placeholder="" value="23, Block C2">
	                                                   </div>
	                                               </div>
	                                               <!-- Form control -->
	                                               <div class="column is-6">
	                                                   <div class="control">
	                                                       ...
	                                                       <input type="text" class="input" placeholder="" value="Church Street">
	                                                   </div>
	                                               </div>
	                                               <!-- Form control -->
	                                               <div class="column is-6">
	                                                   <div class="control">
	                                                       ...
	                                                       <input type="email" class="input" placeholder="" value="100065">
	                                                   </div>
	                                               </div>
	                                               <!-- Form control -->
	                                               <div class="column is-6">
	                                                   <div class="control">
	                                                       ...
	                                                       <input type="email" class="input" placeholder="" value="New York">
	                                                   </div>
	                                               </div>
	                                               <!-- Form control -->
	                                               <div class="column is-6">
	                                                   <div class="control">
	                                                       ...
	                                                       <input type="email" class="input" placeholder="" value="NYC">
	                                                   </div>
	                                               </div>
	                                               <!-- Chosen Select -->
	                                               <div class="column is-6">
	                           ...
	                           <div class="button-wrapper has-text-right">
	                               <router-link to="/checkout-1" class="button feather-button is-small primary-button upper-button raised">
	                                   <span>Previous</span>
	                               </router-link>
