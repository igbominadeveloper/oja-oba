                  ...
                  <div class="column is-10 is-offset-1 checkout-wrapper is-tablet-landscape-padded">
                      ...
                      <div id="payment-methods" class="columns is-multiline">
                          ...
                          <div class="column is-8 is-offset-2 has-text-centered">
                              <router-link to="/checkout-3" class="button feather-button is-small primary-button upper-button raised">
                                  <span>Previous</span>
                              </router-link>
                          </div>
                      </div>
                                  ...
                                  <div class="column is-6 is-padded">
                                      ...
                                      <form>
                                          ...
                                          <div class="has-text-right">
                                              <router-link to="/checkout-step5" class="button feather-button is-small secondary-button upper-button raised">
                                                  <span>Checkout</span>
                                              </router-link>
                                          </div>
                                      </form>
                              ...
                              <div class="columns is-gapless is-vcentered">
                                  ...
                                  <div class="column is-6 is-padded">
                                      <div class="has-text-centered">
                                          ...
                                          <router-link to="/.~BTcheckout-step5" class="button feather-button is-small secondary-button upper-button raised">
                                              <span>Confirm</span>
                                          </router-link>
                                      </div>
                                  </div>
                                              ...
                                              <form>
                                                  <div class="columns is-multiline is-gapless">
                                                      ...
                                                      <div class="column is-12 has-text-right">
                                                          ...
                                                          <router-link to="/checkout-step5" class="button feather-button is-small secondary-button upper-button raised ml-5 mr-5">Checkout</router-link>
                                                      </div>
                                                  </div>
                      ...
                      <div id="cash" class="is-hidden animated preFadeInUp fadeInUp">
                          ...
                          <!-- Back to Payment Methods -->
                          <div class="button-wrapper has-text-right">
                              <a to="javascript:void(0);" class="button feather-button is-small primary-button upper-button raised back-to-methods">
                                  <span>Go back</span>
                              </a>
                          </div>
                      </div>
