<template>
   ...
   <nav class="navbar mobile-navbar is-hidden-desktop is-hidden-tablet" aria-label="main navigation">
       ...
       <div class="navbar-menu">
           ...
           <div class="navbar-item has-dropdown">
               ...
               <!-- Mobile Dropdown -->
               <div class="navbar-dropdown">
                   <router-link to="/products" class="navbar-item">House</router-link>
                   <router-link to="/products" class="navbar-item">Office</router-link>
                   <router-link to="/products" class="navbar-item">Kids</router-link>
                   <router-link to="/products" class="navbar-item">Kitchen</router-link>
                   <router-link to="/products" class="navbar-item">Accessories</router-link>
               </div>
           </div>
       </div>
   </nav>
   ...
   <div class="shop-quickview has-background-image" data-background="assets/images/bg/sidebar.jpeg" style="background-image: url(&quot;assets/images/bg/sidebar.jpeg&quot;);">
       <div class="inner">
           <!-- Header -->
           <div class="quickview-header">
               <h2>Nephos</h2>
               <span id="close-shop-sidebar"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span>
           </div>
           <!-- Shop menu -->
           <ul class="shop-menu">
               <li>
